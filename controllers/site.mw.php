...
/*  $contratosHeader.="<li class='notification'>
  ...
  $contratosHeader.="  <li>
      <a>
        <span class='image'><img src='public/imgs/user.png' alt='Profile Image'></span>
        <span>
  ...
  if (!obtenerAlerta($alert)) {
    ...
    if ($interval->days==29) {
      $email_to = "michi.navarro1994@gmail.com";
      $email_subject = "Alerta Vencimiento de Contratos";
      $email_message = '
        <html>
        <head>
        ...
        <h1>Alerta!</h1>
        <p>
        <b> El contrato #'.$key["ContratoCodigo"].' de la empresa '.$key["EmpresaNombre"].' con servicio '.$key["ServicioNombre"].' esta a 30 dias de expirar.
        </p>
        </body>
        </html>
        ';
        ...
        $headers .= "From: Administrador <desarrollojr@soyservidor.com>\r\n";

        //dirección de respuesta, si queremos que sea distinta que la del remitente
        $headers .= "Reply-To: desarrollojr@soyservidor.com\r\n";

        //ruta del mensaje desde origen a destino
        $headers .= "Return-path: desarrollojr@soyservidor.com\r\n";
...
if ($interval->days==14) {
      ...
      $email_message = '
        ...
        <h1>Alerta!</h1>
        <p>
        <b> El contrato #'.$key["ContratoCodigo"].' de la empresa '.$key["EmpresaNombre"].' con servicio '.$key["ServicioNombre"].' esta a 15 dias de expirar.
        </p>
        </body>
        </html>
        ';
        ...
        //dirección del remitente
        $headers .= "From: Administrador <michi.navarro1994@gmail.com>\r\n";
  ...
  if ($interval->days==6) {
      ...
      <html>
        ...
        <h1>Alerta!</h1>
        <p>
      <b> El contrato #'.$key["ContratoCodigo"].' de la empresa '.$key["EmpresaNombre"].' con servicio '.$key["ServicioNombre"].' esta a 7 dias de expirar.
      </p>
      </body>
      </html>
      ';
                  ...
                  <ul class='nav navbar-nav navbar-right'>
                    <li class=''>
                      <a href='javascript:;' class='user-profile dropdown-toggle' data-toggle='dropdown' aria-expanded='false'>
                        <img src='public/imgs/user.png' alt=''>John Doe
